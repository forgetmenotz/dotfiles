...
you should place your code here."
  ...
  (setq scroll-conservatively 101):warn-unless-encrypted:w
  ...
  (define-key evil-normal-state-local-map (kbd "SPC w j") 'evil-window-left)
  (define-key evil-normal-state-local-map (kbd "SPC w k") 'evil-window-down)
  (define-key evil-normal-state-local-map (kbd "SPC w i") 'evil-window-up)
  (define-key evil-normal-state-local-map (kbd "SPC w l") 'evil-window-right)
