...
(define-key evil-normal-state-map "h" 'evil-open-below)
(define-key evil-normal-state-map "H" 'evil-open-above)
...
(define-key evil-visual-state-map "O" evil-inner-text-objects-map)
